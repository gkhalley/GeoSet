...
Namespace DAL
    Public Class SchoolInterceptorTransientErrors
        ...
        Public Overrides Sub ReaderExecuting(command As DbCommand,
            ...
            Dim throwTransientErrors = False
        ...
        Private Function CreateDummySqlException() As SqlException
            ...
            Dim sqlErrorCtor =
                    GetType(SqlError).GetConstructors(BindingFlags.Instance Or BindingFlags.NonPublic).Where(
                        Function(c) c.GetParameters().Count() = 7).Single()
            ...
            Dim sqlExceptionCtor =
                    GetType(SqlException).GetConstructors(BindingFlags.Instance Or BindingFlags.NonPublic).Where(
                        Function(c) c.GetParameters().Count() = 4).Single()
