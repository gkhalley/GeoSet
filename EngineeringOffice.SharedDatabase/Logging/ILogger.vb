Namespace Logging
    Public Interface ILogger
        ...
        Sub [Error](fmt As String, ParamArray vars As Object())
        Sub [Error](exception As Exception, fmt As String, ParamArray vars As Object())
        ...
        Sub TraceApi(componentName As String, method As String, timespan As TimeSpan, fmt As String,
                     ParamArray vars As Object())
    End Interface
End Namespace